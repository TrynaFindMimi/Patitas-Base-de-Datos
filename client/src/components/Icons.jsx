...
export const IconTruck = ({ className }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
    <path d="M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 01-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h1.125c.621 0 1.129-.504 1.09-1.124a17.902 17.902 0 00-3.213-9.193 2.056 2.056 0 00-1.58-.86H14.25M16.5 18.75h-2.25m0-11.177v-.958c0-.568-.422-1.048-.987-1.106a48.554 48.554 0 00-10.026 0A1.106 1.106 0 002.25 6.615v.958a2.25 2.25 0 002.212 2.25h10.65A2.25 2.25 0 0016.5 7.573z" />
  </svg>
);
...
export const IconPaw = ({ className }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    <path d="M12 14c-2.2 0-4-1.6-4-4s1.8-4 4-4 4 1.6 4 4-1.8 4-4 4z" />
    <path d="M5.5 11c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2z" />
    <path d="M18.5 11c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2z" />
    <path d="M3 16.5c-.8 0-1.5-.7-1.5-1.5s.7-1.5 1.5-1.5 1.5.7 1.5 1.5-.7 1.5-1.5 1.5z" />
    <path d="M21 16.5c-.8 0-1.5-.7-1.5-1.5s.7-1.5 1.5-1.5 1.5.7 1.5 1.5-.7 1.5-1.5 1.5z" />
  </svg>
);

export const IconCat = ({ className }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    <path d="M12 3l1.5 3h-1L12 4.5l-.5 1.5h-1L12 3z" />
    <path d="M12 7c-3.3 0-6 2.5-6 5.5S8.7 18 12 18s6-2.5 6-5.5S15.3 7 12 7z" />
    <path d="M9 12.5c-.6 0-1 .4-1 1s.4 1 1 1 1-.4 1-1-.4-1-1-1z" />
    <path d="M15 12.5c-.6 0-1 .4-1 1s.4 1 1 1 1-.4 1-1-.4-1-1-1z" />
  </svg>
);

export const IconBird = ({ className }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    <path d="M6.5 9C3.5 9 1 11.5 1 14s2.5 5 5.5 5c1.5 0 2.8-.7 3.8-1.8L14 19v-5l4-3-4-3V5l-3.7 3.3C9.3 7.2 8 9 6.5 9z" />
  </svg>
);

export const IconReptile = ({ className }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    <path d="M6 5l4 4-4 4h10l-4-4 4-4H6z" />
    <path d="M10 13l-3 6h5l-2-6z" />
